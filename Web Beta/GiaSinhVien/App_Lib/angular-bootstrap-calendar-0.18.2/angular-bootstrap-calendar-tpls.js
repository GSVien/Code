        ...
        angular
          ...
          .controller("MwlCalendarMonthCtrl", ["$scope", "moment", "calendarHelper", "calendarConfig", function ($scope, moment, calendarHelper, calendarConfig) {
              ...
              $scope.$on("calendar.refreshView", function () {
                  ...
                  vm.view = calendarHelper.getMonthView(vm.events, vm.viewDate, vm.cellModifier, $scope.$parent.$parent.$parent.$parent);
    ...
    /***/ function (module, exports, __webpack_require__) {
        ...
        angular
          ...
          .factory("calendarHelper", ["dateFilter", "moment", "calendarConfig", function (dateFilter, moment, calendarConfig) {
              ...
              function getMonthView(events, viewDate, cellModifier, scopeData) {
                  var startOfMonth = moment(viewDate).startOf("month");
                  var startOfCurrentWeek = moment().startOf("week");
                  var endOfCurrentWeek = moment().endOf("week");
                  ...
                  while (day.isBefore(endOfMonthView)) {
                      ...
                      var inWeek = day.isSameOrAfter(startOfCurrentWeek) && day.isSameOrBefore(endOfCurrentWeek);
                      var isCanSchedule = day.isSameOrAfter(startOfCurrentWeek.clone().add(scopeData.IdUnionOfUser ? 0 : 1, "weeks")) && day.isSameOrBefore(endOfCurrentWeek.clone().add(2, "weeks"));
                      ...
                      var cell = {
                          ...
                          isCanSchedule: isCanSchedule,
                          isUnion: scopeData.IdUnionOfUser,
                          events: monthEvents,
